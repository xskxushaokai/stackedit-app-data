...
如何判断小区间内是否存在根呢？刚才我们已经根据题意推断出，小区间内至多只有$1$个根，所以，如果该区间有且仅有$1$个根（$f(x)=0$），则这个区间的左右两个端点处的函数值符号必定相反（$f(left)*f(right)<0$）。故我们仅需要在满足$f(left)*f(right)<0$的小区间内寻找根即可，q
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjk0MTM0Nzg2LDIwODU5OTM4OSwtMTQ1Nj
k2NjIxOCwtNTMwOTE0MTM4LDEzNTM4NzM5NTAsMTQxMTc2MDQz
NCwxNTUxODk1NDQsLTE0NDI4MzEwODMsLTg5NDEyMjU4MywtMz
YxOTY4MTI5XX0=
-->