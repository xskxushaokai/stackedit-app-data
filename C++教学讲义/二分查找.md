...
int main(){
    ...
    for(int i=-99;i<=100;i++){
        right = fun(i);
        if(left==0) printf("%.2f ", (double)i-1);    // 特判左端点是否为根
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg0NzM4NTg0Myw2NTMwODEwODAsNjkwMz
Y0MjA4LDIyMDMxMzg3NSwzOTcyMTY1OTUsLTE5NzAxODg5NDcs
ODcxMDUyMzU1LDcyMDM2ODc2MywtMTk1ODkwMTU1LC0xOTU0MT
g0NjEzLDE3NDY3MjI2NDcsMjA4NTk5Mzg5LC0xNDU2OTY2MjE4
LC01MzA5MTQxMzgsMTM1Mzg3Mzk1MCwxNDExNzYwNDM0LDE1NT
E4OTU0NCwtMTQ0MjgzMTA4MywtODk0MTIyNTgzLC0zNjE5Njgx
MjldfQ==
-->