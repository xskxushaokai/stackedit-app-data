...
## 分析
**贷款解读：** 何为利率按月累计？即我们常说的**等额本息** 还款方式，假如贷款总额为$w_0$，要还$n$个月，利率为$r$，每月还款额为$w$，则第一个月还款后剩余本息应还总额为：$w0_*(1+r)-w$，第二个月还款后剩余本息应还总额为：$(w0_*(1+r)-w)*(1+r)-w$，第三个月还款后剩余本息应还总额为：$((w0_*(1+r)-w)*(1+r)-w)*(1+r)-w$，
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjYwNjk3NjY5LDE3NDY3MjI2NDcsMjA4NT
