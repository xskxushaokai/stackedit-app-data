...
## 分析
题目给的条件：**存在三个不同实根（根的范围在 $-100$ 至 $100$ 之间），根与根之差的绝对值 $\ge 1$**。这意味着，$[-100,100]$区间内的某个整数$i$，存在一个根属于区间$[i,i+1)$，这样的 $i$有三个，所以我们只需要将区间$[-100,100]$划分为长度为1的小区间，依次判断每个区间内是否存在一个根。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzY2MDA1ODEsMjA4NTk5Mzg5LC0xND
U2OTY2MjE4LC01MzA5MTQxMzgsMTM1Mzg3Mzk1MCwxNDExNzYw
NDM0LDE1NTE4OTU0NCwtMTQ0MjgzMTA4MywtODk0MTIyNTgzLC
0zNjE5NjgxMjldfQ==
-->