...
double bin_search(double left, double right){
    ...
    while(right-left>0.0001){
        ...
        else if (alpha*fun(w0,w,m,left)<=0) right = mid;  // fun(mid)与fun(left)异号，则根一定在[left,mid]之间，故将you'duan'dian
        else left = mid;
    }
    return left;
}
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODAzNzc4NjUsNzIwMzY4NzYzLC0xOT
U4OTAxNTUsLTE5NTQxODQ2MTMsMTc0NjcyMjY0NywyMDg1OTkz
ODksLTE0NTY5NjYyMTgsLTUzMDkxNDEzOCwxMzUzODczOTUwLD
E0MTE3NjA0MzQsMTU1MTg5NTQ0LC0xNDQyODMxMDgzLC04OTQx
MjI1ODMsLTM2MTk2ODEyOV19
-->