...
int main(){
    ...
    for(int i=-99;i<=100;i++){
        right = fun(i);
        if(left==0) printf("%.2f ", (double)i-1);    // 端点特判，后续bin_search中就无需再查找端点
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDc4NjI4NDU5LC01MzA5MTQxMzgsMTM1Mz
g3Mzk1MCwxNDExNzYwNDM0LDE1NTE4OTU0NCwtMTQ0MjgzMTA4
MywtODk0MTIyNTgzLC0zNjE5NjgxMjldfQ==
-->