...
将第`i`种物品拆分成若干件物品，每件物品的体积和价值乘以一个拆分系数$(1,2^1,2^2,...,2^{k-1},s_i-2^{k+1})$，就可以**转化成01背包**的物品求解。例如，$s_i=12$，拆分系数则为$1,2,4,5$，转化成 4 件0/1背包的物品:$(v_i, w_i), (2v_i, 2w_i), (4v_i, 4w_i), (5v_i, 5w_i)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4MzIzMjk1NiwtNzU3NzUwMzA1LDUzMT
cxMzM3NSw2NTE3Mjg4MzksLTUzNjA3MzMyMF19
-->