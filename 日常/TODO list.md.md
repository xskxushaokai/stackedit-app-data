...
- [ ] Infographic（蚂蚁开源可视化图表 https://github.com/antvis/Infographic）
- [ ] 其他优秀项目（一键克隆网站(orchilds.app)，免费API汇总(github: public-apis)）
- [ ] TTS、ASR开源模型（chatterbox、funasr、paraformer(onnx、cpu)、whisper、SenseVoice）
- [ ] Zed（开源，免费平替cursor，评价一般）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1NDYwNDM0NCwxNDc1NzA5MzUzLC04OT
...
MjMwLC0zMjQyNjI2OTEsLTUwOTk4MTMyOSwtMTIxMjM0NDEyMS
wyMDUyMTk0MzQzLC0yMDYwMzEzNTQzLDE1MTMwMzAxMjksMzMx
ODAxMDc5XX0=
-->