...
目前对于课题最重要的应该就是数据，利用AI辅助评价的过程性数据、学生的成绩提升数据、以及对数据进行分析得到的结论。只有这些过程性的数据能够证明你是真正投入了研究的，有了数据，再加上深入的分析，配合上美观的
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzA0MjI4NjAsMTY3MjE2NTYyNCw2ND
