...
目前对于课题最重要的应该就是数据，利用AI辅助评价的过程性数据(学生用的、教师用的)、学生的成绩提升数据、以及对数据进行分析得到的结论。这些数据是别人只有这些过程性的数据能够证明你是真正投入了研究的，有了数据和结论，才能够支撑起课题之后具体的实施计划(比如开发AI OJ系统、设计AI评价方案等，这些工作的开展都是要建立在已经通过对数据进行分析证明了方案有效性的基础上)。而且，如果要写论文的话，数据加上深入的分析，这些是别人没有的东西，再配合上美观的图表，这样写出来的文章才够有深度，也更容易获奖。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2OTI3NDUwLDE2NzIxNjU2MjQsNjQ4Mz
