...
### 开学准备
- [x] 初二上期末成绩备份
- [x] 4道编程测试题，其中两道出自寒假题单
- [x] 教师、学生请假系统测试
- [x] 《AI赋能微课高级特效设计与制作》操作视频
- [x] 课堂测试系统试用
	- [x] 学生名单导入编码问题
	- [x] 成绩统计导出失败
	- [x] 试题讲解模式
	- [x] 题库管理
	- [x] 学生提交后，仍允许登录系统，查看做题记录
	- [x] 查看学生答题情况时，根据提交时间进行筛选
	- [ ] 导出功能，增加一个导出未提交学生


- [x] 正看反说软件架构和简单的介绍，王校课题

- [ ] 东莞人工智能教师基本功比赛
- [ ] 课题问卷
- [ ] 信息学科论文

- [x] obsidian配置，CodeX配置
- [ ] claude code 试用
...
- [ ] yolo26 paper
	- [x] AI总结
	- [ ] 核心技术学习
- [ ] 立体匹配 AANet、Raft-Stereo
- [ ] Kimi论文 [Attention Residuals](https://github.com/MoonshotAI/Attention-Residuals/)
- [ ] deepseek Engram架构《Conditional Memory via Scalable Lookup》

- [ ] 新paper、模型跟进（SAM 3D等），lingbot-VLA项目主页/代码：https://github.com/Robbyant/lingbot-vla

- [x] Infographic（蚂蚁开源可视化图表 https://github.com/antvis/Infographic）
- [x] 其他优秀项目（一键克隆网站(orchilds.app)，免费API汇总(github: public-apis) https://github.com/public-apis/public-apis）
- [ ] TTS、ASR开源模型（chatterbox、funasr、paraformer(onnx、cpu)、whisper、SenseVoice）
- [ ] Zed（开源，免费平替cursor，评价一般）、CodeX (OpenAI)
...
- [ ] 东莞市第四届中小学人工智能教育教学展示活动正式启动，活动将为全市中小学人工智能教师搭建AI教学交流展示平台，助力教师提升教学水平。
活动具体报名、规则及参与方式，请'点击链接查看 https://dgjyw.dgjy.net/info/1021/204693.htm ，也可下载附件获取完整通知，欢迎全市中小学人工智能老师积极参与！(**4月24日之前，报名表+说课视频**)

- [ ] 教育部教育技术与资源发展中心（中央电化教育馆）关于开展2026年教师人工智能应用案例征集活动的通知
https://www.ncet.edu.cn/zhuzhan/ywgzxmhd/20260318/6714.html  （**5月11日-6月30日**）
...
- [ ] OJ系统
	- [ ] 批量创建学生账户
	- [ ] 小组功能（教师可创建小组、添加小组成员、删除小组成员），学生可搜索小组名申请加入小组，小组教师审核后方可加入。
	- [ ] 题单功能（只有教师可以创建题单、通过题号批量添加题目），题单属性包含：题单名称、说明、题目；所有用户都可以查看每个题单下所有用户的完成情况；学生可以查看自己所在小组所有用户的题单完成情况；教师可查看所有小组的题单完成情况并支持按小组导出数据；
...
- [ ] 待规划：如何将初一初二的编程、科创的学生资源利用起来，围绕生成式AI为提升编程能力带来的价值进行详细的方案设计和跟踪调查。可以从搭建C++代码评估Agent入手，让学生进行试用，定期通过编程测试来评估学生的学习效果，从而证明AI辅助评价的有效性。

目前对于课题最重要的应该就是数据，利用AI辅助评价的过程性数据(学生用的、教师用的)、学生的成绩提升数据、以及对数据进行分析得到的结论。这些数据和分析的结果是别人没有的，因为，搞科研的人不会这么深入地去研究应用数据，他们主要聚焦的都是算法本身的优化，做教育的人懂技术懂研究人又很少，所以我们做AI技术在编程教育这个具体领域里的应用，如果我们获得了可靠的数据以及相对比较深入的分析结果，这就是我们的优势。

也只有这些过程性的数据能够证明你是真正投入了研究的，有了数据和结论，才能够支撑起课题之后具体的实施计划(比如开发AI OJ系统、设计AI评价方案等，为什么不直接用传统OJ，因为我们已经证明了AI辅助更高效，这些工作的开展都是要建立在已经通过对数据进行分析证明了方案有效性的基础上)。

而且，如果要写论文的话，有数据加上深入的分析，再配合上美观的图表，这样写出来的文章才够有深度，也更容易获奖。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk1MjIyMjM2LC04MjY0MjY5OTgsLTI5Mj
k1MDU5MSwtMTQ1MTY5NTAyMywtNzQzODE4MzE4LDE3MzE4OTQx
OSw5NjU5NjEzMDksLTEzNTczMTAyNTksLTE3MTY5MDQzMzEsMz
I2NDk0MTQ1LDEwNTkyOTQwMTgsLTE2MTc3MTc5ODAsLTg4Nzg0
NTEzOSwtMTcxNzUyNDIwMiwyOTQwODQxNiwtMzY4MjUwMTc2LC
04NDMxMzU2MjgsMTI5NTI1NDQ3NywxNjcyMTY1NjI0LDY0ODMx
MTMwM119
-->