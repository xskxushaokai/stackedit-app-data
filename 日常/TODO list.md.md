...
目前对于课题最重要的应该就是数据，利用AI辅助评价的过程性数据(学生用的、教师用的)、学生的成绩提升数据、以及对数据进行分析得到的结论。这些数据和分析的结果是别人没有的，因为，搞科研的人不会这么深入地去研究应用数据，他们主要聚焦的都是算法本身的优化，做教育的人懂技术懂研究人又很少，所以我们做了AI技术在编程教育这个具体的领域里的应用，并且获得了可靠的数据以及分析结果，这就是我们的优势。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTIwNzMxNDA3LDE2NzIxNjU2MjQsNjQ4Mz
ExMzAzLC0xMjI2OTc0MDg0LDE5NjU5MDYwOTgsLTE2NjM3ODgx
OCwxOTQyMDE5NDkxLDgyMzE3Mjk4OSwxOTY0MDc5ODM3LDExMj
c3NzIxMiwxNDc1NzA5MzUzLC04OTAwOTg4MjEsMTg4MzM1Mzc2
OSw4MzY4ODAzODUsLTE0MDY5NjkyMDEsMzMyMTE3ODExLC0xNj
g0MzU2OTAxLDQ1NTMyNDY3MSwtMjg5MDczMjA0LC05NzE1MTA2
MDZdfQ==
-->