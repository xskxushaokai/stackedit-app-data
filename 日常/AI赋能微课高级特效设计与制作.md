...
```
注意：接下来我们要对后端代码进行修改，后端代码发生改变后，需要先停止当前的服务，再次重新启动服务更改才会生效。若同时启动两个相同端口号的http服务，则会产生端口号冲突的问题导致服务wu'fa在向AI发起提问前，需要先停止当前正在运行的服务，在TRAE中间下方的终端界面中点击“终止”按钮或使用快捷键“CTRL+C”即可停止当前正在运行的服务。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMTgwOTU1MCw4NDY3NzAzMjEsMTczMD
