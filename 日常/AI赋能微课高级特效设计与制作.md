...
```
可以看到，AI完成了所有代码的编写以及环境的配置，并给出了启动服务器的方法，按照AI给出的快速开始方法一指引，双击运行 start.bat，弹出命令行窗口以及提示信息，如下图所示，提示信息中出现了“Error”类的报错字样，表示运行失败，我们将全部的提示信息复制到T
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxMDA5MDYwMiwtMTkzNDI2OTQ0Nyw3MD
