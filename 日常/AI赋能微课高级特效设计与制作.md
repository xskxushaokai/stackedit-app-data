...
我们再次在浏览器地址栏中输入“http://localhost:3000”进入课堂测试系统，登录教师账号，登录后发现之前“张三”的答题记录仍存在，表明我们停止后台服务后，学生的答题记录并不会被清空，这是合理的。此时看到“统计概览”页面中与之前存在两处变化：1.增加了导出按钮；2.学生得分变为了可点击状态。我们依次测试刚才提出的两点需求，均满足我们提出的要求。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODU2MTY2MDgsMTgxMjMyNDkzLC05MD
