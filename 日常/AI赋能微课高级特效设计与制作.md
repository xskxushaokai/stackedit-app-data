...
3. 功能测试
AI生成的网页应用有时也会存在漏洞（BUG），所以需要教师根据自己提出的功能需求对网页进行测试，这一步非常重要。根据正常的使用流程模拟课堂点名，依次进行“导入名单”-“随机点名”-“结果反馈”三个步骤的测试，为确保整个点名系统的稳定性，需要进行多轮点名测试，点名和评价功能测试无误后，还需要
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyMDk0Mjc5MywyNDc2ODEwNTQsLTIwNT
