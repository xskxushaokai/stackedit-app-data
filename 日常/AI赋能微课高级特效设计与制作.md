...
三、技术要求：
- 使用HTML5 + Tailwind CSS实现样式。
- 引入Font Awesome图标和Google字体。
- 使用纯JavaScript实现交互逻辑（筛选、搜索、滑块、菜单、滚动动画等）。
...
- 页面底部添加版权信息。
- 整体代码结构清晰，注释完整。
- 确保所有功能在移动端和桌面端均可正常使用。

请输出完整的HTML代码，包含所有样式和脚本。
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzkxODI1MjQsLTEyMDA0MDc3ODQsMj
A2MTU5NDM2NCw1MDk0MzU1MjAsNDkzODM3OTE3LDYzMzg0NTA1
NiwtNDYyNDg4NjgxLDE2OTc4NTAzMTEsNzI1Nzg0MjgyLC0xMT
